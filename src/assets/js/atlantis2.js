	...
	if(!minimize_sidebar){
		...
		minibutton.on('click', function() {
			if (mini_sidebar == 1) {
				...
				minibutton.html('<img src="../assets/images/menu-icon.svg" alt="menu icon" class="menu-icon">');
				mini_sidebar = 0;
			} else {
	...
	if(!toggle_overlay_sidebar){
		...
		overlaybutton.on('click', function() {
			if (overlay_sidebar_open == 1) {
				...
				overlaybutton.html('<img src="../assets/images/menu-icon.svg" alt="menu icon" class="menu-icon">');
				overlay_sidebar_open = 0;
			} else {
