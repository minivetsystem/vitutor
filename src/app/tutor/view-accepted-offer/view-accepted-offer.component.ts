...
@Component({
  selector: 'app-view-accepted-offer',
  templateUrl: './view-accepted-offer.component.html',
  styleUrls: ['./view-accepted-offer.component.scss']
})
export class ViewAcceptedOfferComponent implements OnInit {
  offerId;
  OfferDetails={accepted_price: '', image_url: '', id: '', status: '', job_detail: {
    job_title: '', price: '', duration: 1, schedule_date: '', created_at: '' , price_type: '', id: '', job_recurring : null, job_category: '', sub_category_id: '', job_description:'', job_type: ''}, student: {
      full_name: '', image_url: ''
    }, price: 1};
